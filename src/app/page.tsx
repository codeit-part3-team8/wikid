    ...
    <div>
      <section className="relative flex flex-col items-center justify-between">
        <div className="mt-[120px] mb-[100px] flex flex-col text-center sm:mb-[150px] lg:mb-[193px]">
          <div className="flex flex-col gap-[40px]">
            ...
            <span className="responsive-text-nx nx-24-to-20-bold bg-grayscale-500 text-grayscale-50 m-auto w-fit rounded-[15px] px-[30px] py-[15px]">
              위키 만들기
            </span>
          </div>
          <Image
        ...
        <div className="mb-[100px] flex justify-center gap-[10px] sm:mb-[160px] sm:gap-[20px] lg:mb-[200px] lg:gap-[40px]">
          <div className="flex flex-col justify-between gap-[30px] sm:gap-[40px] lg:gap-[60px]">
            ...
            <Image
              ...
              className="h-[162px] w-[133px] sm:h-[322px] sm:w-[262px] lg:h-[450px] lg:w-[364px]"
            />
          </div>
          <Image
            src={shareSection}
      ...
      <section>
        <div className="mt-[100px] sm:mt-[160px] lg:mt-[200px]">
          ...
          <div className="m-auto mb-[200px] flex w-full items-center justify-between gap-[10px] px-[20px] sm:gap-[10px] sm:gap-[20px] sm:px-[48px] md:gap-[20px] lg:gap-[70px] 2xl:px-[70px]">
      ...
      <section className="m-auto mb-[200px] max-w-[924px] px-[20px] sm:px-[48px] lg:px-[0]">
          ...
          <div className="grid w-full grid-cols-3 gap-[10px] sm:gap-[22px] lg:gap-[40px]">
            ...
            <div className="relative col-span-1 aspect-square max-w-[280px]">
              <Image
                ...
                alt="bellIcon 이미지"
                fill
                className="rounded-[16px] bg-[#1584d5] object-cover"
              />
            </div>
      ...
      <section className="bg-grayscale-500 flex h-[329px] flex-col items-center justify-center gap-[40px] sm:h-[488px] lg:h-[568px]">
        ...
        <Link href="/login">
          <button className="responsive-text-nx nx-24-to-20-bold text-grayscale-500 bg-grayscale-50 hover:text-grayscale-50 cursor-pointer rounded-[16px] px-[30px] py-[15px] transition duration-300 hover:bg-gray-500">
            지금 시작하기
          </button>
        </Link>
      </section>
